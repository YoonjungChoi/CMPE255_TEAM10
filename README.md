...
## Introduction
Natural Language Processing(NLP) is a branch of artificial intelligence that helps computers understand and interpret human language and give computers the ability to understand written and spoken words in much the same way human beings can. Worldwide revenue from the NLP market forecasts to be almost 14 times larger in 2025 than it was in 2017, increasing from around three billion U.S. dollars in 2017 to over 43 billion in 2025 [Ref-Statistic](https://www.statista.com/statistics/607891/worldwide-natural-language-processing-market-revenues/). NLP is one of the most promising avenues for social media data processing. It is a interesting challenge to develop powerful methods and algorithms which extract relevant information from data of unstructured format. 
...
Twitter is one of the popular SNS platforms and many tweets has been delivered in emergency situation. This project on Twitter analysis is about prediction problems whether a person's words are actually telling of a disaster.
